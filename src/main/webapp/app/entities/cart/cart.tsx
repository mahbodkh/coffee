...
export const Cart = (props: ICartProps) => {
  ...
  return (
    <div>
      <h2 id="cart-heading">
        <Translate contentKey="coffeeApp.cart.home.title">Carts</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="coffeeApp.cart.home.createLabel">Create new Cart</Translate>
        </Link>
      </h2>
        ...
        {cartList && cartList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="coffeeApp.cart.home.notFound">No Carts found</Translate>
            </div>
          )
        )}
      </div>
