...
import ir.coffee.app.config.audit.AuditEventConverter;
import ir.coffee.app.domain.PersistentAuditEvent;
...
import static ir.coffee.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
